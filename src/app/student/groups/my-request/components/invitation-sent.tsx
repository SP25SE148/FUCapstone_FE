...
export default function InvitationSent() {
  ...
  return (
    <div className="rounded-md border p-4 space-y-2 bg-muted">
      {listRequest?.groupMemberRequestSentByLeader === null ||
      listRequest?.groupMemberRequestSentByLeader?.length === 0 ? (
                ...
                <CardContent className="p-3 sm:p-4">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    <div className="flex flex-wrap items-center gap-2 mt-2 sm:mt-0 justify-end">
                      <div className="mr-2">{getGroupMemberStatus(request.status)}</div>
