    ...
    <div className="flex flex-col gap-2">
      {topicRequests.length > 0 ? (
        <Card className="min-h-[calc(100vh-60px)]">
          <CardHeader>
            <CardTitle className="font-semibold tracking-tight text-lg sm:text-xl text-primary flex items-center gap-2">
                  ...
                  >
                    <div className="grid grid-cols-2 sm:grid-cols-5 gap-4 ">
                      <div className="col-span-2 sm:col-span-2 flex items-center gap-4">
                        ...
                        <div>
                          ...
                          <p className="text-xs sm:text-base font-semibold tracking-tight">
                    ...
                    {request?.status === "Rejected" && (
                      <div className="flex items-center gap-3 mt-4">
                        <div className="bg-primary/10 p-2 rounded-full">
                          <MessageCircleQuestion className="size-4 sm:size-5 text-primary" />
                        </div>
                        <div>
                          <h3 className="text-xs sm:text-sm text-muted-foreground">
                            Reject Reason
                          ...
                          {request?.reason !== "" ? (
                            <p className="text-xs sm:text-base font-semibold tracking-tight break-words whitespace-pre-line">
                              {request?.reason}
                            </p>
                          ) : (
                            <p className="text-xs sm:text-base italic text-muted-foreground">
                              No content
                            </p>
                          )}
                        </div>
