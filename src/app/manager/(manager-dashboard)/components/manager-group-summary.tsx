...
export default function ManagerGroupSummary() {
    const { dashboard } = useManagerDashboard()

    const lowest = dashboard?.worstPerformingGroup
    const highest = dashboard?.bestPerformingGroup
    ...
    return (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <Card className="overflow-hidden border-0 shadow-md bg-gradient-to-br from-green-400/40 to-background">
                <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2 border-b">
                    <CardTitle>Worst Performing Group</CardTitle>
                ...
                {lowest ?
                    ...
                    <CardContent className="flex flex-col items-center justify-center h-[280px] text-center text-muted-foreground space-y-2">
                        ...
                        <p className="text-sm font-medium">No worst performing group yet</p>
                        <p className="text-xs">Once there's data, it will be shown here.</p>
                    </CardContent>}
            </Card>
        </div>
