...
const UpdateStatus: React.FC<UpdateStatusProps> = ({ onUpdate }) => {
  ...
  const getStatusConfig = (status: DefenseCalendarStatus) => {
    switch (status) {
      ...
      case DefenseCalendarStatus.InProgress:
        return {
          label: "In Progress",
      ...
      case DefenseCalendarStatus.Done:
        return {
          label: "Done",
    ...
    <div>
      ...
      <Dialog open={isDialogOpen} onOpenChange={setIsDialogOpen}>
        <DialogContent className="sm:max-w-md">
          <DialogHeader>
            <DialogTitle>Update Defense Calendar Status</DialogTitle>
          </DialogHeader>
              ...
              <div className="space-y-4 py-2">
                <div className="space-y-2">
                  ...
                  <Select
                    ...
                    onValueChange={(value) => setSelectedStatus(Number(value) as DefenseCalendarStatus)}
                  >
